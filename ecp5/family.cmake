    ...
    if (MSVC)
        ...
        foreach (dev ${devices})
            ...
            add_custom_command(OUTPUT ${DEV_CC_BBA_DB}
                COMMAND ${ENV_CMD} ${PYTHON_EXECUTABLE} ${DB_PY} -p ${DEV_CONSTIDS_INC} ${dev} --output ${DEV_CC_BBA_DB}
        ...
        foreach (dev ${devices})
            ...
            set(DEV_CONSTIDS_INC ${CMAKE_CURRENT_SOURCE_DIR}/ecp5/constids.inc)
            add_custom_command(OUTPUT ${DEV_CC_BBA_DB}
                COMMAND ${ENV_CMD} ${PYTHON_EXECUTABLE} ${DB_PY} -p ${DEV_CONSTIDS_INC} ${dev} --output ${DEV_CC_BBA_DB}.new
